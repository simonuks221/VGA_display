...
# xyz
c = [0, 200, 0]  # camera position
# o = [0, -0.05, 0]  # orientation of camera
o = [0, 0, 0]  # orientation of camera
e = [200, 200, 1]  # display surface 1-90laipsniu 2.8 - 48laipsniai
...
# front
points.append([1, 200, 100])
points.append([1, 1, 100])
points.append([200, 1, 100])

points.append([200, 1, 100])
points.append([200, 200, 100])
points.append([1, 200, 100])
